...
func setupMsgServerWithOneGameForPlayMove(t testing.TB) (types.MsgServer, keeper.Keeper, context.Context,
	*gomock.Controller, *testutil.MockBankEscrowKeeper) {
	...
	k, ctx := keepertest.CosmoscheckersKeeperWithMocks(t, bankMock)
...
func setupMsgServerWithOneGameForPlayMoveAndHooks(t testing.TB) (types.MsgServer, keeper.Keeper, context.Context,
	*gomock.Controller, *testutil.MockBankEscrowKeeper, *testutil.MockCosmoscheckersHooks) {
	msgServer, k, context, ctrl, escrow := setupMsgServerWithOneGameForPlayMove(t)
	hookMock := testutil.NewMockCosmoscheckersHooks(ctrl)
	k.SetHooks(hookMock)
