...
func (m *MockPlayerInfoKeeper) PlayerInfoAll(c context.Context, req *types1.QueryAllPlayerInfoRequest) (*types1.QueryAllPlayerInfoResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PlayerInfoAll", c, req)
	ret0, _ := ret[0].(*types1.QueryAllPlayerInfoResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
