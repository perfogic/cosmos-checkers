...
import { PlayerInfo } from "./module/types/cosmoscheckers/player_info"
import { StoredGame } from "./module/types/cosmoscheckers/stored_game"
import { SystemInfo } from "./module/types/cosmoscheckers/system_info"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: perfogic.cosmoscheckers.cosmoscheckers initialized!')
