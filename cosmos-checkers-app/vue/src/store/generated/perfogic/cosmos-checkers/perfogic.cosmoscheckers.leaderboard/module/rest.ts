...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/perfogic/cosmos-checkers/leaderboard/board
   */
  queryBoard = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetBoardResponse, RpcStatus>({
      path: `/perfogic/cosmos-checkers/leaderboard/board`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/perfogic/cosmos-checkers/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/perfogic/cosmos-checkers/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/perfogic/cosmos-checkers/leaderboard/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/perfogic/cosmos-checkers/leaderboard/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/perfogic/cosmos-checkers/leaderboard/player_info/{index}
   */
  queryPlayerInfo = (index: string, params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetPlayerInfoResponse, RpcStatus>({
      path: `/perfogic/cosmos-checkers/leaderboard/player_info/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
